...
impl WorldInfoReader for AnvilLevelInfo {
    fn read_world_info(&self, level_folder: &Path) -> Result<LevelData, WorldInfoError> {
        ...
        level_data.scheduled_events = read_scheduled_events(level_folder);
        level_data.stopwatches = read_stopwatches(level_folder);
...
mod test {
    ...
    use crate::{
        ...
        world_info::{
            ...
            data_files::{
                ScheduledEventsData, ScoreboardData, StopwatchesData, minecraft_data_dir,
            },
        },
    };
    ...
    fn round_trip_level_dat() {
        ...
        original.map_id = 3;
        original.scheduled_events.data_version = original.data_version;
        original.stopwatches.data_version = original.data_version;
